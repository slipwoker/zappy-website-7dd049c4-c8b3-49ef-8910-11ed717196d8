        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '7dd049c4-c8b3-49ef-8910-11ed717196d8',
                name: formData.name,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מרכז להנחיית מאמני כלבי שירות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
